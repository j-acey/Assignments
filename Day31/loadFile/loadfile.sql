...
insert student values(100,'Eric','Ephram', 3.5,1000,1);

insert student values(110,'Greg','Gould', 3.5,1500,2);

insert student values(120,'Adam','Ant', 3.4,1400,3);

insert student values(130,'Howard','Hess', 3.3,1300,3);

insert student values(140,'Charles','Caldwell', 3.2,1200,5);

insert student values(150,'James','Joyce', 3.1,1100,4);

insert student values(160,'Doug','Dumas', 3.0,1000,3);

insert student values(170,'Kevin','Kraft', 2.5,1120,2);

insert student values(180,'Frank','Fountain', 2.7,1130,1);

insert student values(190,'Brian','Biggs', 2.8,1140,5);
